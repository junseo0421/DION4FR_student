...
if __name__ == '__main__':
    # model forward 수정해야함!!!
    NAME_DATASET = 'HKdb-1'
    SAVE_BASE_DIR = '/content/drive/MyDrive/dq_u_net_sep4/output'
    ...
    srd_loss_1 = SRD(s_dim=4, t_dim=32).cuda(0)
    srd_loss_2 = SRD(s_dim=8, t_dim=64).cuda(0)
    srd_loss_3 = SRD(s_dim=16, t_dim=128).cuda(0)
    srd_loss_4 = SRD(s_dim=32, t_dim=256).cuda(0)
