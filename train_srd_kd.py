...
if __name__ == '__main__':
    NAME_DATASET = 'HKdb-2'
    SAVE_BASE_DIR = '/content/drive/MyDrive/kd_afa_net/srd_kd/output'
    ...
    opt_gen = optim.Adam(list(gen.parameters()) +
                         ...
                         list(srd_loss_4.parameters()), lr=args.lr_G, betas=(0.5, 0.999), weight_decay=1e-4)
