...
from dataset import dataset_norm_input_ab
import argparse
        ...
        for batch_idx, (gt, mask_img) in enumerate(train_loader):  # 24.09.20 수정
            ...
            for _ in range(2):
                ...
                gen_loss = pixel_rec_loss + gen_adv_loss + mrf_loss.cuda(
                    0) + total_ssim_loss + total_sobel_loss + original_kd_loss + afa_loss
...
if __name__ == '__main__':
    ...
    train_data = dataset_norm_input_ab(root=args.train_data_dir, transforms=transformations, imgSize=192, inputsize=128,
    ...
    valid_data = dataset_norm_input_ab(root=args.train_data_dir, transforms=transformations_valid, imgSize=192, inputsize=128,
