...
if __name__ == '__main__':
    NAME_DATASET = 'HKdb-2'
    SAVE_BASE_DIR = '/content/drive/MyDrive/kd_afa_net/dq_sep_unet_sobel_afa/output'
    ...
    gen = DQ_Thin_Sep_UNet_4_Feature(n_channels=3, n_classes=3).cuda()  # U-Net student model
