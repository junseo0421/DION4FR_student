...
class Sep_UNet_Feature(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False):
        ...
        self.low_attention_weights1 = torch.nn.Parameter(torch.randn(64, 64, 1, 1) * 0.01)
        self.high_attention_weights1 = torch.nn.Parameter(torch.randn(64, 64, 1, 1) * 0.01)

        self.low_attention_weights2 = torch.nn.Parameter(torch.randn(128, 128, 1, 1) * 0.01)
        self.high_attention_weights2 = torch.nn.Parameter(torch.randn(128, 128, 1, 1) * 0.01)

        self.low_attention_weights3 = torch.nn.Parameter(torch.randn(256, 256, 1, 1) * 0.01)
        self.high_attention_weights3 = torch.nn.Parameter(torch.randn(256, 256, 1, 1) * 0.01)

        self.low_attention_weights4 = torch.nn.Parameter(torch.randn(512, 512, 1, 1) * 0.01)
        self.high_attention_weights4 = torch.nn.Parameter(torch.randn(512, 512, 1, 1) * 0.01)
...
class D_Thin_Sep_UNet_4_Feature(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False):
        ...
        self.low_attention_weights1 = torch.nn.Parameter(torch.randn(16, 16, 1, 1))
        self.high_attention_weights1 = torch.nn.Parameter(torch.randn(16, 16, 1, 1))

        self.low_attention_weights2 = torch.nn.Parameter(torch.randn(32, 32, 1, 1))
        self.high_attention_weights2 = torch.nn.Parameter(torch.randn(32, 32, 1, 1))

        self.low_attention_weights3 = torch.nn.Parameter(torch.randn(64, 64, 1, 1))
        self.high_attention_weights3 = torch.nn.Parameter(torch.randn(64, 64, 1, 1))

        self.low_attention_weights4 = torch.nn.Parameter(torch.randn(128, 128, 1, 1))
        self.high_attention_weights4 = torch.nn.Parameter(torch.randn(128, 128, 1, 1))
