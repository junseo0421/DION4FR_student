...
def build_model(config):
    ...
    elif model_type == 'swin_cross_attn_ResB_v2':
        model = swin_cross_attn_RESB_v2(pre_step=config['pre_step'],
                                img_size=config['IMG_SIZE'],
                                patch_size=config['SWIN.PATCH_SIZE'],
                                in_chans=config['SWIN.IN_CHANS'],
                                embed_dim=config['SWIN.EMBED_DIM'],
    ...
    elif model_type == 'swin_cross_attn_ResB_v2_student':
        model = swin_cross_attn_RESB_v2_student(pre_step=config['pre_step'],
                                img_size=config['IMG_SIZE'],
                                patch_size=config['SWIN.PATCH_SIZE'],
                                in_chans=config['SWIN.IN_CHANS'],
                                embed_dim=config['SWIN.EMBED_DIM'],
