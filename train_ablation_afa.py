...
if __name__ == '__main__':
    ...
    # gen = V_Thin_Sep_UNet_4_Feature(n_channels=3, n_classes=3).cuda()
    # gen = DQ_Thin_Sep_UNet_4_Feature(n_channels=3, n_classes=3).cuda()
    gen = V_Thin_Sep_UNet_4_Ablation_HP(n_channels=3, n_classes=3).cuda()
    # gen = V_Thin_Sep_UNet_4_Ablation_LP(n_channels=3, n_classes=3).cuda()
