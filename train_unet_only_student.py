...
if __name__ == '__main__':
    NAME_DATASET = 'HKdb-1'
    SAVE_BASE_DIR = '/content/drive/MyDrive/d_thin_u_net_sep4/output'
    ...
    # config = {}
    # config['pre_step'] = 1
    # config['TYPE'] = 'swin_cross_attn_ResB_v2_student_1'
    # config['IMG_SIZE'] = 224
    ...
    gen = D_Thin_Sep_UNet_4(n_channels=3, n_classes=3).cuda()
